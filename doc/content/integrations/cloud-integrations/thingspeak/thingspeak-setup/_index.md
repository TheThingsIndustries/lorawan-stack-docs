...
>**Note:** You should enable a field for each metric you want to send inside the `decoded_payload` object of the [uplink message]({{< ref "/reference/data-formats#uplink-messages" >}}).
