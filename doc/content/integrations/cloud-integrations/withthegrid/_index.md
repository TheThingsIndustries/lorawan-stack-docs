...
Click **ADD** to set the channel and click **ADD** to **UPDATE** to save the changes.
...
Now that the webhook and the event handler of Dragino - LWL02 are configured, we can set up  TTN project. 
