...
aliases: [/reference/federated-auth/oidc/microsoft-entra]
---
...
If all your configuration is correct, you will now be redirected to {{% tts %}} console and you will be logged in. The username is chosen based on the rules explained in the [generating usernames]({{< ref "/concepts/features/sso#generating-usernames" >}}) section.
