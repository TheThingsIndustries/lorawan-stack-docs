...
In this section, we explain how to manage organizations and grant them rights using {{% tts %}} [Console]({{< ref "/concepts/features/console" >}}) and the [CLI]({{< ref "/concepts/features/cli" >}}).
