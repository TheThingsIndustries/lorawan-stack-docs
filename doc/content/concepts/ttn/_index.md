---
title: "The Things Stack Sandbox"
aliases: [/getting-started/ttn, /reference/ttn]
---
...
See the [Addresses]({{< ref "/concepts/ttn/addresses" >}}) for details about cluster, Console, API endpoints and other {{% ttss %}} addresses.
