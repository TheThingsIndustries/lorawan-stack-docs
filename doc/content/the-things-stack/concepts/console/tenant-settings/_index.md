...
If you want to customize the [Web UI Branding]({{< ref "/reference/branding" >}}) of your tenant's Console, you need to provide the source of your branding assets. Paste the source URL into the **Branding base URL** field.
