...
description: ""
weight:
aliases: [/devices/the-things-uno, /devices/models/the-things-uno]
---
...
- Hardware Ver. – `1.0`
- Firmware Ver. – `quickstart` or `abp`. We recommend you to use `quickstart` as it supports [OTAA]({{< ref "/hardware/devices/concepts/abp-vs-otaa#otaa" >}}).
