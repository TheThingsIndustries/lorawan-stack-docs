...
description: ""
weight: -1
aliases: [/devices/best-practices, /devices/concepts/best-practices]
---
...
Devices should also randomize initial power on delay (i.e. Join). See [Synchronization, Backoff, and Jitter]({{< ref "/hardware/devices/concepts/best-practices#synchronization-backoff-and-jitter" >}}).
