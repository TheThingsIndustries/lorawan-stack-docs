...
To connect the gateway via UDP packet forwarder, first follow [these instructions]({{< ref "/hardware/gateways/concepts/udp" >}}) to obtain `global_conf.json` file, then follow instructions below.
