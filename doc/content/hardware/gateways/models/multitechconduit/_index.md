...
aliases:
  [
    /guides/connecting-gateways/multitechconduit,
    /gateways/multitechconduit,
    /gateways/models/multitechconduit,
  ]
...
Now, in the downloaded logs, open the _lora-pkt-fwd-1.log_ file to see the packet forwarder logs.
