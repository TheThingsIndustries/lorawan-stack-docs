...
description: ""
aliases:
  [/gateways/tektelickonamicro/udp, /gateways/models/tektelickonamicro/udp]
---

This section guides you to connect the Tektelic Kona Micro IoT LoRaWAN® Gateway to {{% tts %}} using the [{{% udp-pf %}}]({{< ref "/hardware/gateways/concepts/udp" >}}).
