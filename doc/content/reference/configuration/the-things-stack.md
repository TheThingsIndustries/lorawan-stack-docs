...
## License {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
## Key Vault {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
- `redis.readonly.address`: Address of the Redis server {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `redis.readonly.password`: Password of the Redis server {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `redis.readonly.database`: Redis database to use {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `redis.readonly.pool-size`: The maximum size of the connection pool {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
- `events.redis.readonly.address`: Address of the Redis server {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `events.redis.readonly.password`: Password of the Redis server {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `events.redis.readonly.database`: Redis database to use {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `events.redis.readonly.pool-size`: The maximum size of the connection pool {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
## Multi-Tenancy {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}

In multi-tenant deployments, some additional configuration is required.

- `tenancy.base-domains`: Base domains for tenant ID inference. Setting this to `thethings.example.com` would extract the tenant ID from `<tenant-id>.thethings.example.com`. {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `tenancy.default-id`: Default tenant ID. Users visiting `thethings.example.com` (from `tenancy.base-domains`) will be redirected to `default.thethings.example.com`. {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
- `tenancy.ttl`: TTL of cached tenant configurations {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
