...
- `is.read-database-uri`: Read-Only database connection URI {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
- `is.oauth.ui.branding-cluster-id`: The cluster ID to show below the logo {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
- `is.oauth.ui.branding-text`: The branding text to show below the logo {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
## Tenant Administration Options {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
- `is.tenancy.admin-keys`: Keys that can be used for tenant administration (16, 24 or 32 hex-encoded bytes) {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
