...
## Peering {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
...
- `ns.switch-peering-tenant-context`: Switch tenant context in peering {{< distribution-inline "Cloud Hosted" "Self Hosted" >}}
