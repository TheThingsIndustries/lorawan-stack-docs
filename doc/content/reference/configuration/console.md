...
- `console.ui.branding-cluster-id`: The cluster ID to show below the logo {{< distribution-inline "Cloud" "Enterprise" >}}
- `console.ui.branding-text`: The branding text to show below the logo {{< distribution-inline "Cloud" "Enterprise" >}}
