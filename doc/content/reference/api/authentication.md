...
To register OAuth client you can use {{% tts %}} [Console]({{< ref "/the-things-stack/concepts/interact/console" >}}) or [CLI](https://www.thethingsindustries.com/docs/the-things-stack/concepts/interact/cli/).
