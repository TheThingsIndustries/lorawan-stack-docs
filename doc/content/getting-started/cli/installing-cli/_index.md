...
{{< info >}} When installing with `brew`, auto-completion is enabled automatically. {{</ info >}}
...
{{< info >}} When installing with `snap`, auto-completion is enabled automatically. {{</ info >}}
