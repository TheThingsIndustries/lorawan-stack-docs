...
You will also need to [configure the CLI]({{< ref "the-things-stack/concepts/cli/installing-cli#generate-configuration-file" >}}), to use the static IP of your machine as the address of {{% tts %}}. 
