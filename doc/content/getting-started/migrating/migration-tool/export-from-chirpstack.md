...
After exporting, devices and applications can be imported in {{% tts %}}. See [Import End Devices in {{% tts %}}]({{< ref "/getting-started/migrating/import-devices" >}}) for details about importing devices.