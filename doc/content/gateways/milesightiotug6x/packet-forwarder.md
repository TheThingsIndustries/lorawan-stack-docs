<<<<<<< HEAD:doc/content/gateways/milesightiotug6x/packet-forwarder.md
---
...
For the **Server Address** choose **custom**, and enter the same as what you use in the [Getting Started guide]({{< ref "/getting-started" >}}).
