...
description: ""
weight: 3
aliases: ["/gateways/rak-7240/pf.md"]
---

RAK7240's **Packet Forwarder** mode utilizes the [{{% udp-pf %}}]({{< ref "/gateways/gateways-by-model/udp" >}}) protocol. Follow this section to learn how to connect to {{% tts %}} Network Server using this mode.
