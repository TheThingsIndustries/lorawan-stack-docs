...
The **Milesight UG6X LoRaWAN Gateway** is a series of 2 robust 8-channel LoRaWAN gateways for industrial IoT applications.

{{< figure src="ug6x.jpg" alt="Milesight IoT UG6x" class="plain float" >}}

This page contains information about connecting the Milesight IoT UG6x LoRaWAN Gateway to {{% tts %}}.

<!--more-->

The technical specifications can be found in Milesight's official pages of [UG65](https://www.milesight-iot.com/lorawan/gateway/ug65/) and [UG67](https://www.milesight-iot.com/lorawan/gateway/ug67/). The Milesight UG6X LoRaWAN Gateways support two ways to connect with {{% tts %}}, using either the Semtech Packet Forwarder or {{% lbs %}}.
