...
Manage Forwarder routing policies
...
* [ttn-lw-cli packetbroker forwarders policies list]({{< relref "ttn-lw-cli_packetbroker_forwarders_policies_list" >}})	 - List routing policies configured by Forwarders
