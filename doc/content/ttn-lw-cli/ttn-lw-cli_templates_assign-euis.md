...
Assign JoinEUI and DevEUIs to end device templates (EXPERIMENTAL)
...
```
ttn-lw-cli templates assign-euis [join-eui] [start-dev-eui] [flags]
```
...
```
      --count int               (default 1)
  -h, --help                   help for assign-euis
      --join-eui string        (hex)
      --start-dev-eui string   (hex)
```
