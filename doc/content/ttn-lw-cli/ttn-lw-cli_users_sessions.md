...
* [ttn-lw-cli users sessions delete]({{< relref "ttn-lw-cli_users_sessions_delete" >}})	 - Delete a user session
* [ttn-lw-cli users sessions list]({{< relref "ttn-lw-cli_users_sessions_list" >}})	 - List user sessions
