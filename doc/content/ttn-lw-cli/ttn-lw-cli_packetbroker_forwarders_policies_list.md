...
List routing policies configured by Forwarders

```
ttn-lw-cli packetbroker forwarders policies list [flags]
```
...
* [ttn-lw-cli packetbroker forwarders policies]({{< relref "ttn-lw-cli_packetbroker_forwarders_policies" >}})	 - Manage Forwarder routing policies
