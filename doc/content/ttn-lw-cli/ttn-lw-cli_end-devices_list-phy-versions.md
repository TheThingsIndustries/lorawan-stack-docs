---
title: "ttn-lw-cli end-devices list-phy-versions"
slug: ttn-lw-cli_end-devices_list-phy-versions
---

## ttn-lw-cli end-devices list-phy-versions

List supported phy versions

```
ttn-lw-cli end-devices list-phy-versions [flags]
```
