---
title: "ttn-lw-cli alert-notification-profiles list"
slug: ttn-lw-cli_alert_notification_profiles_list
---

## ttn-lw-cli alert-notification-profiles list

List an alert notification profile (EXPERIMENTAL)

```
ttn-lw-cli alert-notification-profiles list [flags]
```
