...
Disassociate and delete the device from Join Server

```
ttn-lw-cli end-devices use-external-join-server [application-id] [device-id] [flags]
```
...
```
      ...
      --dev-eui string          (hex)
      --device-id string        
  -h, --help                    help for use-external-join-server
      --join-eui string         (hex)
```
