...
```
ttn-lw-cli users set [user-id] [flags]
```
...
```
      ...
      --console-preferences.tutorials.seen strings     allowed values: TUTORIAL_UNKNOWN, TUTORIAL_LIVE_DATA_SPLIT_VIEW, TUTORIAL_LORAWAN_STARTER_USER
      --description string                             
      --gateway-limit uint                             
  -h, --help                                           help for set
      --name string                                    
