...
* [ttn-lw-cli users oauth authorizations delete]({{< relref "ttn-lw-cli_users_oauth_authorizations_delete" >}})	 - Delete an OAuth authorization and all access tokens
* [ttn-lw-cli users oauth authorizations list]({{< relref "ttn-lw-cli_users_oauth_authorizations_list" >}})	 - List OAuth authorizations
