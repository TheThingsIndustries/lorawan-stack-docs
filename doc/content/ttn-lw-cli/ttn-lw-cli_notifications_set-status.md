---
title: "ttn-lw-cli notifications set-status"
slug: ttn-lw-cli_notifications_set-status
---

## ttn-lw-cli notifications set-status

Set the status of notifications

```
ttn-lw-cli notifications set-status [flags]
```
